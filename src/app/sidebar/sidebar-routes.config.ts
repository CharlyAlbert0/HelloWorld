...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/pages/users', title: 'Usuarios', icon:'material-icons' },
    { path: '/pages/roles', title: 'Roles', icon:'material-icons' },
    { path: '/pages/tipoactivo', title: 'Tipos de Activo', icon:'material-icons' },
    { path: '/pages/departamento', title: 'Departamentos', icon:'material-icons' },
    { path: '/pages/activos', title: 'Activos', icon:'material-icons' },
